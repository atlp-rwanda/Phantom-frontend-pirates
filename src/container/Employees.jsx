...
import SideBar from "../components/RegisterSidebar";
  ...
  return (
    <div className="flex flex-no-wrap">
      ...
      <div className="container mx-auto py-10 bg-gray-100 h-auto md:w-4/5 w-11/12 px-6">
        ...
        <div className="p-6 w-full bg-white mt-12 place-content-center rounded-lg border border-gray-200 shadow-md">
