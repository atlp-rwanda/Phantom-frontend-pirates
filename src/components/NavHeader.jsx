...
function Navheader({t}) {
  ...
  return (
    <div className="w-screen h-[90px] z-10 border-b-2 border-cyan-700 fixed drop-shadow-lg">
        ...
        <div className="flex items-center w-full justify-between">
          ...
          <div className="md:flex items-center">
            <div className="md:pr-[90px]">
              <ul className="hidden md:flex text-cyan-700 font-semibold ">
                <li>
                  <Link  to='/'>
                    <a className='hover:text-yellow-400 focus:outline-none' 
                    >{t('navbar.home')}</a
                    >
                  </Link>
                </li>
            ...
            <div className="hidden md:flex h-[30px] pr-[70px]">
              ...
              <button onClick={onLogout} className="w-[90px] border-button-color border-fon text-white bg-red-700 hover:bg-button-color hover:text-white hover:border-none">
                ...
                <>
                <button className="w-[90px] border-button-color border-fon text-yellow-400 bg-transparent hover:bg-button-color hover:text-white hover:border-none">
                <Link to='/login'>
                  <a>{t('navbar.signIn')}</a>
                </Link>
              </button>
