...
const DeletePermCard = (props) => {
  ...
  const RemoveHundler = (permId, roleId) => {
    const url = 'api/permission/' + roleId + '/role/' + permId;
    dispatch(fetchAsyncRemovePermission(url));
  };
