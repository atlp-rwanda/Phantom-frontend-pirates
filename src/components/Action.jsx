...
import { fetchAsyncBuses,getBuses,updateBus,deleteBus, reset } from '../../features/buses/busSlice';
...
function BusTable() {
    ...
    const handleClick = (newPlacement,id,plate,category,seat) => (event) => {
      setBusId(id);
      setBusPlate(plate);
                        ...
                        <td>
                          <Box sx={{ width: 90 }} className='w-4'>
                              ...
                              <Grid container justifyContent="center">
                                  <Button onClick={handleClick('left-start', bus.id, bus.plate, bus.category,bus.seat)
