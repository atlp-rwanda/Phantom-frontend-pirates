...
function RouteTable() {
    ...
    const { isLoading,isSuccessDelete,message, isSuccess,isRejected } = useSelector(
      (state) => state.routes
    )
    ...
    useEffect(() => {
      ...
      setOpen(false)
      }, [dispatch,isSuccess,isSuccessDelete,isRejected]);
                          ...
                          <div className="relative w-full my-6 mx-auto max-w-3xl">
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                              <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                                <h1>View ROUTE <span className='text-xl font-bold'> {routeSource}-{routeDestination}</span></h1>
